...
static std::vector<std::string> s_Preset_print_options {
    ...
    "top_surface_line_width", "support_line_width", "infill_wall_overlap","top_bottom_infill_wall_overlap", "bridge_flow", "bridge_line_width", "bridge_line_width", "internal_bridge_flow",
